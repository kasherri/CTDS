...
from .utils import blockwise_NNLS, estimate_J,blockwise_NMF, solve_constrained_QP, check_qp_condition
...
class CTDS(SSM):
    ...
    def transition_distribution(
        ...
        """
        #inputs = inputs if inputs is not None else jnp.zeros(self.inputs_shape)
    ...
    def initialize_dynamics(self, V_list,U) -> ParamsCTDSDynamics:
        ...
        V_dale=jnp.concatenate(V_list, axis=1)
        A=V_dale.T @U
