...
class CTDS(SSM):
    ...
    **Observations:**
    ...
    def m_step(self,
               ...
               props: Optional[ParamsCTDS]=None
    ...
    def fit_em(self, 
        ...
        batch_emissions : Array, shape (B, T, N)
        ...
        """
        if batch_emissions.ndim == 2:
            batch_emissions = batch_emissions[None, ...]  # Add batch dimension
        def em_step(params, m_step_state):
            ...
            params, m_step_state = self.m_step(params, batch_stats, m_step_state)
